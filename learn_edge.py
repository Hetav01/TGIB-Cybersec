...
random_seed = 42  # or any other value you prefer
...
g_df = pd.read_csv('/Users/hetavpatel/Desktop/Data Science/Grad DS Work/DSCI 789 Explainable AI/TGIB-main/TGIB_Data/wikipedia/ml_wikipedia.csv'.format(DATA))
e_feat = np.load('/Users/hetavpatel/Desktop/Data Science/Grad DS Work/DSCI 789 Explainable AI/TGIB-main/TGIB_Data/wikipedia/ml_wikipedia.npy'.format(DATA)) 
n_feat = np.load('/Users/hetavpatel/Desktop/Data Science/Grad DS Work/DSCI 789 Explainable AI/TGIB-main/TGIB_Data/wikipedia/ml_wikipedia_node.npy'.format(DATA)) 
